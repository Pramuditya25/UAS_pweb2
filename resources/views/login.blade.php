    ...
    <body>
        <div class="font-sans text-gray-900 antialiased">
            <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-[#f8f4f3]">
                <div>
                    <a href="{{ url('login') }}">
                        <h2 class="font-bold text-3xl">Selamat <span class="py-2 bg-[#f84525] text-white px-2 rounded-md">Datang</span></h2>
                    </a>
                </div>
                ...
                <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
                    <form method="POST" action="">
                        ...
                        <div class="flex items-center justify-center mt-4">
                            ...
                            <a href="/" class = 'ms-4 inline-flex items-center px-4 py-2 bg-[#f84525] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-red-800 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150' type="submit">
                                Back
                            </a>
